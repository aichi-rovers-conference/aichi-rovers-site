  ...
  return (
    <div className="w-full bg-white">
      ...
      <section className="w-full bg-white py-10 sm:py-12 md:py-16 px-4 sm:px-6 md:px-10 lg:px-16">
        ...
        {/* 各セクション */}
        <TextRightImage title="ARC総会・定例会" imgSrc="/images/ARC_02.jpg" imgAlt="総会・定例会の様子" siteKey="arc.activity1">
          <p>
        ...
        <TextRightImage title="ARC交流会" imgSrc="/images/ARC_03.jpg" imgAlt="交流会の様子" siteKey="arc.activity2">
          <p>
        ...
        <TextRightImage title="ARC運営委員セミナー" imgSrc="/images/ARC_05.jpg" imgAlt="運営委員セミナーの様子" siteKey="arc.activity4">
          <p>
        ...
        <TextRightImage title="その他事業の運営" imgSrc="/images/ARC_06.jpg" imgAlt="各種事業の様子" siteKey="arc.activity5">
          <p>
