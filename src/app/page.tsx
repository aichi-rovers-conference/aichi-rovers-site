      ...
      <section className="w-full bg-white py-10 sm:py-12 md:py-16 px-4 sm:px-6 md:px-10 lg:px-16">
        ...
        >
          <div>
            ...
            <Link href="/arc/conference" className="relative z-10 mt-3 inline-block">
              <motion.span
      ...
      <section className="bg-white pb-10 px-4 sm:px-6 md:px-10 lg:px-16">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="pt-8 sm:pt-10 px-0 sm:px-2 md:px-6">
            <h3
              className="text-red-600 font-bold mb-5 leading-tight"
              ...
              {[
                ...
                <li key={item.href}>
                  <motion.a
                    ...
                    whileTap={{ scale: 0.98 }}
                    transition={{ type: "spring", stiffness: 320, damping: 22 }}
                    className="flex items-center gap-3 px-4 py-3 rounded-lg border border-gray-200 text-black font-semibold text-sm sm:text-base"
                  >
